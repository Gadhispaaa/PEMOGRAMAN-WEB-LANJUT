    ...
    <div class="body-wrapper mt-2 flex gap-[2rem]">
        ...
        <table>
          <tbody>
            <tr>
              ...
              <td class="ps-1 font-semibold text-lg">35071347XXXXXXXX</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
                Nama <span>:</span>
              </td>
              <td class="ps-1 text-sm uppercase">GADHIS PRAMESTYA ARIFIN</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
                Tempat/Tgl Lahir <span>:</span>
              </td>
              <td class="ps-1 text-sm">MALANG, 07-02-2003</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
            ...
            <tr>
              ...
              <td class="ps-1 text-sm">DESA SUKUN</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
                <span class="ms-9">RT/RW</span> <span>:</span>
              </td>
              <td class="ps-1 text-sm">010/005</td>
            </tr>
            <tr>
              <td class="w-48 flex justify-between text-sm">
      ...
      <div class="left-content grid">
        <div class="image-wrapper w-full">
          <img src="{{asset('img/cantik.jpeg')}}" class=" object-cover h-full w-40 rounded" />
        </div>
